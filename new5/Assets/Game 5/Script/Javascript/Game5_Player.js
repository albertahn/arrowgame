...
//Add forward force
				ball.GetComponent.<Rigidbody>().AddForce(ball.transform.forward * (575 * Vector3.Distance(touchPosition,ballStartPosition.position)));
				//Set ball position
				...
				GetComponent.<AudioSource>().clip = audioSlingshot;
